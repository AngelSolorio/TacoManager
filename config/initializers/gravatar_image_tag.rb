GravatarImageTag.configure do |config|
  config.default_image           = 'assets/images/person.png'   # Set this to use your own default gravatar image rather then serving up Gravatar's default
  ...
  config.rating                  = nil   # Set this if you change the rating of the images that will be returned ['G', 'PG', 'R', 'X'].
  config.size                    = 112   # Set this to globally set the size of the gravatar image returned (1..512). Gravatar's default is 80
